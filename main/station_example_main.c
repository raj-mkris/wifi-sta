/* WiFi station Example with OTA Support
...
void ota_task(void *pvParameter)
{
    while (1)
    {
        ...
        vTaskDelay(10000 / portTICK_PERIOD_MS); // Check for updates every 10 seconds
    }
}
...
void app_main(void)
{
    ...
    // Create the OTA task
    xTaskCreate(&ota_task, "ota_task", configMINIMAL_STACK_SIZE * 5, NULL, 5, NULL);
}
